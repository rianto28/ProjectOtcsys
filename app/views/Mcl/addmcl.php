            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                ADD DATA MASTER CUSTOMER LIST (MCL)
                            </h2>
                            ...
                            <div class="tab-content">
                                ...
                                <div role="tabpanel" class="tab-pane animated flipInX" id="profile_with_icon_title">
                                    ...
                                    <p>
                                       <form action="<?= BASEURL; ?>/mcl/tambah" method="POST">
                                            <input type="hidden" name="kodemr" value="<?= $data['mr']['kodeana'] ?>">    
                                             <input type="hidden" name="grupoutlet" value="noo">                                                                                     
                                            <label for="outlet">Outlet Name</label>
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <select class="form-control show-tick" data-live-search="true" id="outlet" name="outlet">
                                                        ...
                                                        <?php foreach ($data['noo'] as $noo) : ?>
                                                            ...
                                                            <option value="<?= $noo['outletid']; ?>"><?= $noo['outletname']." &nbsp [".$noo['address']."]"; ?></option>
                                                ...
                                                <div class="form-line">
                                                    <select class="form-control show-tick" data-live-search="true" id="outlet" name="outlet">
                                                        ...
                                                        <?php foreach ($data['kuota'] as $kuota) : ?>
                                                            ...
                                                            <option value="<?= $kuota['outletid']; ?>"><?= $kuota['outletname']." &nbsp [".$kuota['address']."]"; ?></option>
