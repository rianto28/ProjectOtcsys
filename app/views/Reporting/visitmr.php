<div class="card">
    <div class="header">
        <h2>
            Visit MR <small>Reporting Visit MR</small>
        </h2>
                            
    </div>
    <div class="body">
                            </p>
                                <form action="<?= BASEURL; ?>/Reporting/visitmr" method="POST">
                                                    ...
                                                    <div class="card">
                                                                ...
                                                                <table class="table table-striped">
                                                                    <thead>
                                                                        <tr bgcolor="#F44336">
                                                                            ...
                                                                            <th><p class="font-bold col-white">STATUS</th>
                                                                        </tr>
                                                                    </thead>
                                                                    <tbody>
                                                        <?php 
                                                        ...
                                                        ?>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <?php 
                                                                                if($wpc['status']==1){
                                                                                    $status= "<input type=checkbox id=basic_checkbox_4 class=filled-in checked disabled />
                                                                        <label for=basic_checkbox_4>Visited</label>";
                                                                                }else{
                                                                                    $status = "<input type=checkbox id=basic_checkbox_4 class=filled-in disabled />
                                                                                    <label for=basic_checkbox_4>Not Visited</label>";
                                                                                }
                                                                                if($no==1){
                                                                            ...
                                                                            ?>
                                                                                ...
                                                                                <td bgcolor="#009688"><p class="font-bold col-white"><?= $status; ?></p></td>
                                                                            <?php }else{ ?>
                                                                                <td><?= $no; ?></td>
