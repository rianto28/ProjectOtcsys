...
class TCPDF {
	...
	public function Header() {
		if ($this->header_xobjid === false) {
			...
			$this->SetLineStyle(array('width' => 0.00 / $this->k, 'cap' => 'butt', 'join' => 'miter', 'dash' => 0, 'color' => $headerdata['line_color']));
			...
			//Ganti Cell(..., 0, '', 'T', 0, 'C') menjadi Cell(..., 0, '', 0, 0, 'C') untuk menghilangkan GARIS di HEADER
